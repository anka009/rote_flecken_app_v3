...
if uploaded_files:
    for i, uploaded_file in enumerate(uploaded_files):
        ...
        for j, frame in enumerate(frames):
            ...
            filled_output = None  # wichtig zur Weiterverwendung
            output_clustered = None
            ...
            if centers:
                ...
                # 🟠 Gruppierte Umrisse separat
                output_clustered = image_np.copy()
                cv2.drawContours(output_clustered, merged_contours, -1, (0, 255, 255), 4)
